...
export interface Friend { id: string; name: string; isMe: boolean; archived: boolean; archivedAt?: Timestamp | null; photoURL?: string | null; photoStoragePath?: string | null; createdAt: Timestamp; updatedAt: Timestamp }
...
export interface FolderFinancials { folder: Folder; contributions: ContributionWithExpenses[]; settlements: Settlement[] }
export interface Settlement { id: string; folderId: string; fromFriendId: string; toFriendId: string; amount: number; date: Timestamp; note?: string; source?: "individual" | "all"; createdAt: Timestamp; updatedAt: Timestamp }
export interface ActivityEntry { id: string; action: string; description: string; entityType: string; entityId?: string; folderId?: string; createdAt: Timestamp }
