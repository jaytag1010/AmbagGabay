...
export interface ExpenseDraft { id: string; title: string; amount: string; participantIds: string[] }
export interface ContributionInput { title: string; date: Date; payerFriendId: string; participantIds: string[]; expenses: Array<{ title: string; amount: number; participantIds: string[] }> }
